...
namespace WPFInvoiceSystem.Utils.Constants
{
    public static class ViewNames
    {
        public const string CustomerSubformView = nameof(CustomerSubformView);
        ...
        public const string ServiceSubformView = nameof(ServiceSubformView);
    }
}
